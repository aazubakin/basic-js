...
module.exports = function repeater(str, options) {
  ...
  //make addition string
  for (let j = 0; j < myObj.additionRepeatTimes - 1; j++) {
    if (myObj.additionRepeatTimes > 1) myObj.additionStr += myObj.additionSeparator + myObj.addition;
    //else myObj.additionStr += myObj.addition;
  }
